...
- [后端编码规范](agents/coding-style.md)：Python 编码风格和实现约束。
- [前端编码规范](agents/frontend-coding-style.md)：Vue、TypeScript 和前端实现约束。
...
1. 始终读取本索引。
2. 读取与当前任务相关的规则文件；修改代码时至少读取项目、开发、测试和对应技术栈的编码规范。
